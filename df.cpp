...
{ 
   // int depth = 1;
    ...
    // int level = 0;
    //cout<<"1:Depth: "<<depth<<" Level: "<<level<<" Limit: "<<limit<<endl;
    while (!q.empty()) 
    { 
        states_explored++;
        ...
        else
        {
            ...
            { 
                ...
                { 
                    ...
                    visited[row][col] = true; //uncomment this! 
...
*/
int final_DFIS(int** mat, int n, int m, Point src, Point dest, int limit, queueNode* prev_ptr, bool** visited) 
{ 
    states_explored++;
    ...
    { 
        ...
        { 
            ...
            int dist = final_DFIS(mat, n, m, curr_point, dest, limit-1, root, visited);
            if(dist>-1)
            {
                return dist;
            }
    ...
    */
    ...
    else if(mode == 2)
    {
        ...
        while(true)
        {
            ...
            dist = 0;
            dist = final_DFIS(input, n, m, source, dest, limit, root, visited);
            if(dist == -1)
            {
                limit++;
            }
